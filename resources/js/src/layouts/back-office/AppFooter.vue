    ...
    <footer class="footer has-cards">
        <div class="container">
            <div class="row row-grid align-items-center my-md">
                <div class="col-lg-6">
                    <h3 class="text-primary font-weight-light mb-2">Terimakasih atas dukungan kalian.</h3>
                    <h4 class="mb-0 font-weight-light">Ayo segera hubungi kami.</h4>
                </div>
            ...
            <div class="row align-items-center justify-content-md-between">
                <div class="col-md-6">
                    <div class="copyright">
                        &copy; {{year}}
                        <a href="#" target="_blank" rel="noopener">PT Alba Digital Teknologi</a>
                    </div>
                </div>
            </div>
        </div>
